...
$.ajax({
           type: 'GET',
           url: "https://developers.zomato.com/api/v2.1/search?entity_id=292&entity_type=city" + searchCity + "&count=100",
           processData: true,
           headers: {
        "user-key": "e16e542baf4d0f96dc3b01b14d0723e6",
        'Content-Type': 'json'
       },
           data: {},
           dataType: "json",
       ...
       $.each(data, function(index, value) {
        ...
        $.each(x, function(index, value) {
         ...
         html += "<a href='Menu?address="+ location.address +"'  class='action_link'><h2 style='color:red;'><strong>" + value.name + "</strong></h2></a>";
